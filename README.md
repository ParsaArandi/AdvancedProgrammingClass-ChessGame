...
> **یادداشت درباره نمادهای یونیکد:**  
> تیم تلاش کرد از نمادهای یونیکد شطرنج (♔ ♕ ♖ ♗ ♘ ♙) استفاده کند، اما به دلیل اینکه هر نماد عرض متفاوتی داشت و نقاط هم‌ترازی در ترمینال تنظیم نمی‌شدند، مجبور به استفاده از حروف لاتین شدند. در صورت امکان در فازهای بعدی این مشکل برطرف خواهد شد.

---

*مستند شده توسط هوش مصنوعی بر اساس کد منبع پروژه*
